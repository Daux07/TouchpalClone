 ...
 *
 * [Shift], [ModeSwitch], [Emoji] and [Mic] are present for layout fidelity with
 * the original TouchPal but are wired for real in Phase 3; for now they are no-ops.
 */
sealed interface KeyAction {
    ...
    data object ModeSwitch : KeyAction   // "12#" numeric/symbol mode — Phase 3
